  ...
  entries: [
    ...
    },
    {
      ...
      description: {
        ...
        'zh-CN': 'IP 封禁表示系统因风险、滥用或异常原因，临时或永久阻止来自某个网络地址的流量。',
      },
    },
    {
      id: 'error-decay',
    ...
    },
    {
      ...
      description: {
        ...
        'zh-CN': '异常是指明显偏离正常预期的模式或数值，可能意味着滥用、故障或数据问题。',
      },
    },
    {
      id: 'incident',
    ...
    },
    {
      ...
      description: {
        ...
        'zh-CN': '服务中断表示某项服务在一段时间内完全不可用，请求无法被正常处理。',
      },
    },
    {
      id: 'degradation',
    ...
    },
    {
      ...
      description: {
        ...
        'zh-CN': '事件订阅用于定义哪些系统事件会触发通知、Webhook 投递或其他自动响应。',
      },
    },
    {
      id: 'access-key',
