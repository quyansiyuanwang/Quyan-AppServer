  ...
  entries: [
    ...
    },
    {
      ...
      description: {
        ...
        'zh-CN': '在线率或可用性，表示某个服务在统计周期内保持可使用、可响应的时间占比。',
      },
    },
    {
      id: 'monitoring',
      ...
      description: {
        ...
        'zh-CN': '监控是指持续观察服务健康、性能、错误或安全信号，以便尽早发现并处理问题。',
      },
    },
    {
      id: 'queue',
    ...
    },
    {
      ...
      description: {
        ...
        'zh-CN': '超时表示某个请求或操作耗时过长，系统在达到预期等待上限后停止继续等待。',
      },
    },
    {
      id: 'retry',
      ...
      description: {
        ...
        'zh-CN': '重试是指在失败、超时或临时错误之后，再次尝试执行同一个请求或操作。',
      },
    },
    {
      id: 'provider',
      ...
      description: {
        ...
        'zh-CN': '供应商或提供方，指真正提供模型、接口能力或外部资源的上游服务来源。',
      },
    },
  ],
}
