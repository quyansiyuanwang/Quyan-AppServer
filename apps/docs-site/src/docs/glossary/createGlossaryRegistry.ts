...
import type { GlossaryEntry, GlossaryModule, GlossaryRegistry } from '@/docs/glossary/types'

export const createGlossaryRegistry = (modules: GlossaryModule[]): GlossaryRegistry => {
