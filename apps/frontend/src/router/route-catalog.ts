...
const legacyRoutePathByName: Record<string, string> = {
  ...
  myCarpools: '/account/product-subscriptions/carpools',
  carpoolDetail: '/account/product-subscriptions/carpools/:id',
  ...
  carpoolManagement: '/management/carpools',
...
export const routeCatalog = attachLegacyPaths([
  ...
  { name: 'captchaVerification', group: 'shared', path: '/auth/captcha' },
