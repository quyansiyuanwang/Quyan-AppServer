      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            path: 'products/kv',
            name: 'product-kv',
            component: () => import('@/views/products/DeveloperProductUserView.vue'),
            props: { product: 'kv' },
          },
          {
          ...
          },
          {
            ...
            component: () => import('@/views/products/DeveloperProductManagementView.vue'),
            props: { product: 'kv' },
          ...
          },
          {
            ...
            component: () => import('@/views/products/DeveloperProductConfigView.vue'),
            props: { product: 'kv' },
