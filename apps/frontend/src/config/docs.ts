...
const docsRouteToSlug = {
  ...
  systemOAuthClientManagement: 'oauth-app-management',
  ...
  relayAIRequestLogs: 'ai-request-logs',
  ...
  myCarpools: 'carpools',
  carpoolDetail: 'carpools',
  carpoolInvite: 'carpools',
  carpoolManagement: 'carpool-management',
  carpoolPackageManagement: 'carpool-management',
