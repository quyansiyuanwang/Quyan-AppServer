<template>
  ...
  <section v-for="runItem in runs" :key="runItem.id" class="run-card">
    ...
    <el-descriptions :column="2" border size="small"
      ...
      ><el-descriptions-item :label="i18ns.t('relay.channelProbeBalanceSettlementTolerance')">{{
        formatNumber(runItem.balanceSettlementTolerance)
      }}</el-descriptions-item
      ...
      ><el-descriptions-item :label="i18ns.t('relay.channelProbeStrictCalibrationValidation')">{{
