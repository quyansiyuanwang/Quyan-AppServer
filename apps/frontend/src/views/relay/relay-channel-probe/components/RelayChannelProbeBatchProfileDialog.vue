...
const { batchProfileDialogOpen, batchProfileOverwriteExisting, batchProfileSourceChannelId, batchProfileSources, batchProfileSaving, batchProfileTargets, resetBatchProfileDialog, submitBatchProfileCopy } = useRelayChannelProbeManagementContext()
</script>
