...
const {
  applying, batchRunning, canAdjust, canBatchCopyProfile, canExecute, canSelectRow, changeDialogOpen, confirmApply, confirmBatchRun, confirmResetRunState, enabledFilter, filteredItems, forceWithoutCacheBuster, isApplicable, keyword, loadOverview, loading, onSelectionChange, openBatchProfileDialog, openDrawer, pageError, profileFilter, resettingChannelId, run, runStatuses, runStatusFilter, runningId, runnableChannelIds, selectedRows, selectedRuns, statusLabel, suggestionFilter, tableRef,
