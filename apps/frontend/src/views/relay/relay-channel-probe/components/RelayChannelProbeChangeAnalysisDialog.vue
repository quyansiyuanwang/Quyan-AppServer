...
const { changeDialogOpen, changeDirection, changeDisplayDigits, changeDisplayRoundingMode, changeMinimumPercent, changePage, changePageSize, changeSort, changeTypeFilter, customerFacingDirectionMaximumPercent, exportMultiplierChangeChart, formatChangeValue, formatDate, formatNumber, multiplierChangeRows, multiplierDirectionClass, multiplierDirectionLabel, multiplierDirectionStyle, pagedCustomerFacingMultiplierChangeRows, publicMultiplierChangeRows } = useRelayChannelProbeManagementContext()
</script>
