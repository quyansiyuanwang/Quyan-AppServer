...
const { applyDialogOpen, applyDirectionMaximumPercent, applyDrafts, applyTableRef, applying, clearDraftSelection, exportAppliedChangeChart, formatMultiplierChange, formatMultiplierChangePercent, formatNumber, multiplierChangeClass, multiplierDirectionClass, multiplierDirectionLabel, multiplierDirectionStyle, onApplySelectionChange, rememberApplySettings, roundingDigits, roundingMode, selectEligibleDrafts, selectedApplyRunIds, selectionDirection, selectionTolerancePercent, submitApplyMultipliers, targetLocalCost } = useRelayChannelProbeManagementContext()
</script>
