...
const { addCredential, addWorkflowStep, applyPayloadPreset, availableVariables, balancePathCount, cacheModeHelp, canExecute, clearingProfile, confirmClearProfile, copyConfiguration, copyVariable, credentialNames, credentials, currenciesMatch, downloadConfiguration, form, formatNumber, isProbeFormatAvailable, openImportDialog, payloadText, probeEndpointHelp, probeEndpointLabel, probeEndpointOptions, requiredCredentialStates, removeWorkflowStep, saving, saveProfile, selected, selectedProbeModels, variableTemplate, workflowSteps } = useRelayChannelProbeManagementContext()
</script>
