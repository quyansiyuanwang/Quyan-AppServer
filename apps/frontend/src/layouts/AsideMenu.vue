  ...
  const sections: OverviewSection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          visible: can(Permission.RELAY_CHANNEL_HEALTH_READ),
        },
        {
          key: 'relayRequestDiagnostics',
          label: i18ns.t('nav.relayRequestDiagnostics'),
          icon: Monitor,
          route: 'relayRequestDiagnostics',
    ...
    },
    {
      ...
      items: [
        ...
        {
          key: 'ticketReviewManagement',
          label: i18ns.t('nav.ticketReviewManagement'),
          icon: ChatDotRound,
          route: 'ticketReviewManagement',
          visible: can(Permission.TICKET_REVIEW_READ),
        },
      ],
    },
    {
