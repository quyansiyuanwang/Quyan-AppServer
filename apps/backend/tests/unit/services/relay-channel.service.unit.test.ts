...
describe("RelayChannelService", () => {
  ...
  it("publishes pooled channels with their logical fixed price without topology", async () => {
  ...
  it("retains a submitted multiplier when validating a logical pooled channel", async () => {
    ...
    expect(validated.multiplier).toBe(42);
  });
