...
export const contentSafetyConfigSchema = z.object({
  ...
  requestMaxAction: z.enum(["unreachable", "blackhole", "allow"]),
  ...
  responseMaxAction: z.enum(["unreachable", "blackhole", "allow"]),
...
export const contentSafetyUserConfigSchema = z.object({
  ...
  requestMaxAction: z.enum(["unreachable", "blackhole", "allow"]).nullable(),
  ...
  responseMaxAction: z.enum(["unreachable", "blackhole", "allow"]).nullable(),
