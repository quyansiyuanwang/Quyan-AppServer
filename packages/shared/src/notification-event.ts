...
export const NOTIFICATION_EVENT_I18N_KEYS: Record<NotificationEvent, string> = {
  ...
  [NotificationEvent.FEEDBACK_PENDING_REVIEW]: "notificationEvent.feedback_pending_review",
  [NotificationEvent.FEEDBACK_STATUS_UPDATED]: "notificationEvent.feedback_status_updated",
  [NotificationEvent.FEEDBACK_PUBLIC_REPLY]: "notificationEvent.feedback_public_reply",
  [NotificationEvent.FEEDBACK_ASSIGNED]: "notificationEvent.feedback_assigned",
